                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <div class="mt-2">
                                        <TextInput
                                            ...
                                            :required="true"
                                        />
                                        <JetInputError v-show="errors && errors.role"
                                                       :message="errors.role ? errors.role.join(','): ''" class="mt-2"/>
                                    ...
                                    <span class="font-medium text-gray-900">
                                      ...
                                      />
                                                                            ...
                                                                            <div class="max-w-lg space-y-4">
                                                                                <div>
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        <div
                                                                                            class="flex flex-grow"></div>
                                                                                        <div
                                                                                            class="flex items-center h-full pr-2">
                                                                                            <input
                                                    ...
                                                    <JetInputError v-show="errors && errors.permissions"
                                                                   :message="errors.permissions ? errors.permissions.join(','): ''"
                                                                   class="mt-2"/>
                                                </div>
                                            </div>
                                        </div>
...
export default {
    ...
    setup (props, {emit}) {
        ...
        const createRole = async () => {
            let response = await store.dispatch("teamRoles/createRole", {
                role: role.value,
