    ...
    <div class="h-full fixed right-0 top-0 bot-0 z-10 shadow-md bg-gray-100">
      <div class="flex flex-col pt-10 w-16">
        <div class="my-4 text-center">
          <button v-tippy="'Show/Hide Sources'" class="group" id="sources" @click="active('Sources')">
        ...
        <div class="my-4 text-center">
          <button v-tippy="'Show/Hide Sinks'" class="group" @click="active('Sinks')">
        ...
        <div class="my-4 text-center">
          <button v-tippy="'Show/Hide Links'" class="group" @click="active('Links')">
