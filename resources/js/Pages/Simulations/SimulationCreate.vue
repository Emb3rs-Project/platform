  ...
  <app-layout>
    ...
    <div class="mt-10 sm:mt-0 p-10">
      <div class="md:grid md:grid-cols-3 md:gap-6">
            ...
            <nav aria-label="Progress">
              <ol class="overflow-hidden">
                ...
                >
                  ...
                  >
                    <!-- Complete -->
                    <span class="h-9 flex items-center" v-if="step.completed">
                      <span
        ...
        <!-- Form Step 1 -->
        <div class="mt-5 md:mt-0 md:col-span-2" v-if="currentStep.id === 1">
        ...
        <!-- Form Step 2 -->
        <div class="mt-5 md:mt-0 md:col-span-2" v-if="currentStep.id === 2">
          <div class="shadow overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 bg-white sm:p-6">
              <div class="grid grid-cols-6 gap-6">
                <div class="col-span-12" v-for="i of [1, 2, 3]" :key="i">
                  <!-- Constraints -->
                  <div class="col-span-12">
                    <select-row
        ...
        <!-- Form Step 3 -->
        <div class="mt-5 md:mt-0 md:col-span-2" v-if="currentStep.id === 3">
          <div class="shadow overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 bg-white sm:p-6">
              <div class="grid grid-cols-6 gap-6">
                <div class="col-span-12">
        ...
        <!-- Form Step 4 -->
        <div class="mt-5 md:mt-0 md:col-span-2" v-if="currentStep.id === 4">
          <div class="shadow overflow-hidden sm:rounded-md">
            <div class="px-4 py-5 bg-white sm:p-6">
              <div class="grid grid-cols-6 gap-6">
                <div class="col-span-12">
                ...
                <!-- Source -->
                <div class="col-span-12" v-for="sink of sinks" :key="sink.id">
                  <div class="flex items-center justify-between">
                    <span
                      class="flex-grow flex flex-col"
                      id="availability-label"
...
export default {
  ...
  setup(props) {
    ...
    const simulation_types_select = props.simulation_types.map((s) => ({
      key: s.id,
      value: s.name,
    }));
